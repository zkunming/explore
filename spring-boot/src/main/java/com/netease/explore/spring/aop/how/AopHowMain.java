...
public class AopHowMain
{
	public static void main(String[] args) throws ClassNotFoundException
	{
		...
		Class<?> aClass = Class.forName(AopHow.class.getName(), false, AopHowMain.class.getClassLoader());
		...
		//4、创建动态代理实现类
		AopHow aopHowDynamicProxy = (AopHow) Proxy.newProxyInstance(AopHowMain.class.getClassLoader(), proxyInterface, logInvocationHandler);
